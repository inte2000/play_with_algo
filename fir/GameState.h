...
protected:
    ...
    int CountEmptyCell();
    int AnalysisLine(int st, int dir_step, EvaluatorData &ev_ata);
    bool CheckFiveInRow(int cell, int player_id);
    bool CheckLinefive(int cell, int dir_step, int player_id);
    ...
    int SkipEmptyCell(int cs, int dir_step);
    int SearchAndCountChess(int cs, int dir_step, int chess_id, int& count);
